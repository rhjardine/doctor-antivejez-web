...
const config: Config = {
  ...
  theme: {
    // Se preserva la sección 'container' si existía, o se puede añadir
    container: {
      center: true,
      padding: "2rem",
      screens: {
  	...
  	extend: {
        ...
        // Añadimos nuestros colores de estado personalizados para poder usarlos como clases de Tailwind
